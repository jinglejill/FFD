//
//  ReportSalesByMenuTypeWeeklyTableViewController.m
//  FFD
//
...
#import "ReportSalesByMenuTypeWeeklyTableViewController.h"
...
@interface ReportSalesByMenuTypeWeeklyTableViewController ()
{
...
@implementation ReportSalesByMenuTypeWeeklyTableViewController
...
- (void)loadViewProcess
{
    ...
    [self.homeModel downloadItems:dbReportSalesByMenuTypeWeekly withData:@[startDate,endDate]];
}
...
- (void)itemsDownloaded:(NSArray *)items
{
    ...
    if(self.homeModel.propCurrentDB == dbReportSalesByMenuTypeWeekly)
    {
...
{
    [self loadingOverlayView];
    [self exportImpl:@"ยอดขายแยกตามหมวดรายการอาหารรายสัปดาห์"];
}
...
-(void) exportCsv: (NSString*) filename
{
    ...
    else
    {
        ...
        header0 = [NSString stringWithFormat:@"วันที่%@,ยอดขาย(บาท)\n",header0];
