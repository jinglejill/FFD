//
//  ReportSalesByMenuTypeWeeklyGraphViewController.m
//  FFD
//
...
#import "ReportSalesByMenuTypeWeeklyGraphViewController.h"
#import "SalesDaily.h"
...
@interface ReportSalesByMenuTypeWeeklyGraphViewController ()
{
...
@implementation ReportSalesByMenuTypeWeeklyGraphViewController
...
-(void)configureGraph
{
    ...
    // 4 - Set up title
    NSString *title = @"ยอดขายตามหมวดรายการอาหารรายสัปดาห์";//@"Sales by Channel";
    graph.title = title;
