//
//  ReportSalesAllWeeklyGraphViewController.m
//  FFD
//
...
#import "ReportSalesAllWeeklyGraphViewController.h"
#import "SalesDaily.h"
...
@interface ReportSalesAllWeeklyGraphViewController ()
{
...
@implementation ReportSalesAllWeeklyGraphViewController
...
-(void)configureGraph
{
    ...
    // 4 - Set up title
    NSString *title = @"ยอดขายรายสัปดาห์";//@"Sales by Channel";
    graph.title = title;
