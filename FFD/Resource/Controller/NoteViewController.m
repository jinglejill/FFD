...
-(void)viewDidLayoutSubviews
{
    ...
    NSLog(@"note frame: (%f,%f)",self.view.frame.size.width,self.view.frame.size.height);
}
...
//    colVwNote.collectionViewLayout = [[NDCollectionViewFlowLayout alloc]init];
