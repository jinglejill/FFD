//
//  ReportSalesAllMonthlyGraphViewController.m
//  FFD
//
...
#import "ReportSalesAllMonthlyGraphViewController.h"
#import "SalesDaily.h"
...
@interface ReportSalesAllMonthlyGraphViewController ()
{
...
@implementation ReportSalesAllMonthlyGraphViewController
...
-(void)configureGraph
{
    ...
    // 4 - Set up title
    NSString *title = @"ยอดขายรายเดือน";//@"Sales by Channel";
    graph.title = title;
