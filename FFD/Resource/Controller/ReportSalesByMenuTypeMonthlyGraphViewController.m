//
//  ReportSalesByMenuTypeMonthlyGraphViewController.m
//  FFD
//
...
#import "ReportSalesByMenuTypeMonthlyGraphViewController.h"
#import "SalesDaily.h"
...
@interface ReportSalesByMenuTypeMonthlyGraphViewController ()
{
...
@implementation ReportSalesByMenuTypeMonthlyGraphViewController
...
-(void)configureGraph
{
    ...
    // 4 - Set up title
    NSString *title = @"ยอดขายตามหมวดรายการอาหารรายเดือน";//@"Sales by Channel";
    graph.title = title;
