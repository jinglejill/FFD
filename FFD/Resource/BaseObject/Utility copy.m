...
+ (NSString *) url:(enum enumUrl)eUrl
{
    ...
    switch (eUrl)
    {
        ...
        case urlOrderTakingOrderNoteOrderKitchenGetList:
            ...
            break;
        case urlOrderTakingOrderNoteOrderKitchenInsertList:
            url = @"/FFD/MAMARIN5/FFDOrderTakingOrderNoteOrderKitchenInsertList.php";
            break;
        ...
        case urlNoteTypeDeleteList:
            ...
            break;
        case urlReceiptAndReceiptNoTaxUpdate:
            url = @"/FFD/MAMARIN5/FFDReceiptAndReceiptNoTaxUpdate.php";
            break;
...
{
    NSArray *arrMasterClass = @[@"UserAccount",@"LogIn",@"CustomerTable",@"MenuType",@"Menu",@"TableTaking",@"OrderTaking",@"MenuTypeNote",@"Note",@"OrderNote",@"OrderKitchen",@"Member",@"SubMenuType",@"Address",@"Receipt",@"Discount",@"Setting",@"RewardProgram",@"RewardPoint",@"ReceiptNo",@"ReceiptNoTax",@"ReceiptCustomerTable",@"SpecialPriceProgram",@"MenuIngredient",@"IngredientType",@"Ingredient",@"SubIngredientType",@"NoteType",@"UserTabMenu"];
