...
- (NSString *)renderInvoice:(NSString *)invoiceNumber invoiceDate:(NSString *)invoiceDate customerName:(NSString *)customerName customerAddress:(NSString *)customerAddress customerTaxNo:(NSString *)customerTaxNo items:(NSMutableArray *)items totalAmount:(NSString *)totalAmount totalAmountBeforeVat:(NSString *)totalAmountBeforeVat vat:(NSString *)vat totalAmountIncludeVat:(NSString *)totalAmountIncludeVat
{
    ...
    htmlContent = [htmlContent stringByReplacingOccurrencesOfString:@"#TOTAL_AMOUNT_INCLUDE_VAT#" withString:totalAmount];
